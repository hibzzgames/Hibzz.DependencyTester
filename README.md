...
***HAS NO ACTUAL FUNCTIONALITY. JUST TESTS DEPENDENCIES. DONT DOWNLOAD :)***

## Installation
**Via Github**
This package can be installed in the Unity Package Manager using the following git URL.
```
https://github.com/hibzzgames/Hibzz.DependencyTester.git
```

Alternatively, you can download the latest release from the [releases page](https://github.com/hibzzgames/Hibzz.DependencyTester/releases) and manually import the package into your project.
